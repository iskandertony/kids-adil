...
export function NewsCard  (){
    return (
        <div className={"flex flex-col min-h-[475px] shadow-xl gilroy bg-white leading-2 min-w-[325px] p-[10px] rounded-[12px]"}>
                <Image src={"/images/new.svg"} width={305} height={196} alt={"new"} />
                <div className="p-4">
