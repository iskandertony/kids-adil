        ...
        <div className=" mx-auto  bg-cream  grid grid-cols-1 grid-flow-dense lg:grid-cols-2 xl:gap-[100px] gap-8">
            ...
            <div className={"order-1 md:order-2"}>
                ...
                <p className="text-[#397BE8] font-medium text-[20px] mt-4">
                    ...
                    Прозрачность: Все собранные средства мы направляем исключительно на лечение и помощь детям. Мы публикуем отчеты о расходах и обязательно делаем их доступными для наших сторонников.
                    Честность и доверие: Мы всегда честно и открыто работаем с теми, кто нуждается в поддержке, и с теми, кто решает помочь.
                    Социальная ответственность: Мы считаем, что помощь должна быть оказана без условий и различий, независимо от социального положения и других факторов.
                </p>
                <p className="text-[#397BE8] gilroy font-medium text-[20px] mt-8">
                    ...
                    Волонтеры: Мы всегда рады добровольцам, которые готовы помочь нам в организации мероприятий, сборе средств и в других активностях фонда.
                    Партнеры: Мы открыты для сотрудничества с другими благотворительными фондами, медицинскими учреждениями, а также с частными компаниями, готовыми поддержать наши инициативы.
                </p>
            </div>
        </div>
    </section>
