        ...
        <section id={"about"} className={"flex flex-col justify-center items-center py-[100px] xl:container"}>
           <Titling color={"#DD91BC"} title={"O фонде"}/>
            ...
            <div className={"flex flex-col relative md:pt-0 p-4  text-white pt-[5vh]  min-h-[300px] w-[100vw] lg:mt-[50px] mt-[200px] xl:w-[1360px] py-[50px]  gap-y-[50px]"}>
                ...
                <a href={"/about"}><button className={ "w-[125px] md:min-w-[125px] h-[44px] rounded-[50px] border-[1px]  border-white flex items-center z-100 justify-center text-white bg-[#transtperent]"}>Подробнее</button></a>
                ...
                <Image alt={"about item"} src={"/images/about-item.svg"} width={252} height={158} className={"absolute md:top-[45%] top-[45vh] hidden z-10 md:block right-[-25vw] md:bottom-0 md:-left-[100px]"}/>
            </div>
        </section>
        </section>
    )
