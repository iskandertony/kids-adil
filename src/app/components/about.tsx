    ...
    return (
        <section id={"about"} className={"flex flex-col justify-center items-center py-[100px] xl:container"}>
           <Titling color={"#DD91BC"} title={"O Фонде"}/>
            <div className={"relative rounded-[35px] w-[100vw] h-[130vh]  pt-[30px] text-white bg-[#67519F] xl:h-[445px] xl:w-[1360px] flex-col flex md:flex-row  "}>
                <div className="flex flex-col py-[20px] md:py-[50px]  px-7 md:w-[67%] gap-y-7">
                    <h2 className={"text-[40px] md:text-[45px] font-[500] gilroy"}>ОСНОВНАЯ ЦЕЛЬ ПРОЕКТА ФОНДА</h2>
                ...
                <div className={"md:w-[30%] relative flex  items-center justify-center"}>
                    <Image alt={"children"} src="/images/about-children.svg" width={1000} height={1000} className={"w-[100vw] z-10 md:w-[535px] h-[480px]   md:scale-125"}/>
            ...
            <div className={"flex flex-col relative md:pt-0 p-4  pt-[5vh]  min-h-[300px] w-[100vw] lg:mt-[50px] mt-[200px] xl:w-[1360px] py-[50px]  gap-y-[50px]"}>
                ...
                <Image alt={"about item"} src={"/images/about-item.svg"} width={252} height={158} className={"absolute md:top-[45%] top-[45vh] right-[-25vw] md:bottom-0 md:-left-[100px]"}/>
            </div>
        </section>
    )
}